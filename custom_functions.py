...
def create(command, now_directory):
    if command[1] == "file":
        if len(command) == 2:
            with open(os.path.join(now_directory, "newFile"), "w"):
                pass
        else:
            with open(os.path.join(now_directory, command[2]), "w"):
                pass
    elif command[1] == "folder":
        if len(command) == 2:
            os.mkdir(os.path.join(now_directory, "newFolder"))
        else:
            os.mkdir(os.path.join(now_directory, command[2]))
